...
fetch('./json/objects.json')  // Realiza uma requisição para buscar o arquivo 'objects.json'
    ...
    .catch(error => console.error('Erro ao carregar o arquivo JSON:', error));  // Caso ocorra algum erro durante o fetch ou processamento, ele será capturado aqui e exibido no console